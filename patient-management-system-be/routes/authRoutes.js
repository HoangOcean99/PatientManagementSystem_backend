...
import { changePassword, requestForgetPassword, requestRegister, resetPassword, signOut, syncUserGoogle, verifyAndCreateUser, verifyResetOtp } from '../controllers/authController.js';
...
authRoutes.post('/change-password/:userId', requireAuth, changePassword);
